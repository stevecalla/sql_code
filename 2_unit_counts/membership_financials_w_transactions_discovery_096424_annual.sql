...
WITH membership_sales_annual_purchase_6 AS (
    SELECT 
...
-- SELECT * FROM membership_sales_annual_purchase_6 ORDER BY member_number_members

-- GET COUNT = ? for 2021
-- SELECT
--     COUNT(DISTINCT max_membership_period_id) as purchases
-- FROM membership_sales_annual_purchase_6
