...
WITH participation_by_race AS (
        ...
        -- WHERE 
                -- YEAR(r.start_date) >= 2010
                -- CHECKING NULL COUNT
                -- r.start_date >= '2021-06-01 00:00:00'
                -- AND r.start_date <= '2021-06-15 00:00:00'
...
-- SELECT * FROM participation_by_race WHERE event_id = 30783;
-- SELECT COUNT(*) FROM participation_by_race;
-- SELECT COUNT(DISTINCT event_id) FROM participation_by_race; -- 17,8917
-- SELECT COUNT(DISTINCT id_race_results) FROM participation_by_race; -- 37,944