...
profile_race_counts AS (
    ...
    GROUP BY start_date_year_races, id_profile_rr
),
...
LEFT JOIN profile_buckets pb ON o.race_year = pb.race_year
--   AND o.name_event_type = pb.name_event_type
-- ORDER BY o.race_year, o.name_event_type;
ORDER BY o.race_year;
