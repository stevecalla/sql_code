...
WITH overall_summary AS (
    ...
    GROUP BY start_date_year_races, member_created_at_category
),
...
profile_race_counts AS (
    ...
    WHERE 
        ...
        -- AND name_event_type = 'Adult Event'
    GROUP BY start_date_year_races, member_created_at_category, id_profile_rr
),
...
profile_buckets AS (
    ...
    GROUP BY race_year, member_created_at_category
)
...
LEFT JOIN profile_buckets pb
  ...
  AND o.member_created_at_category = pb.member_created_at_category
ORDER BY o.member_created_at_category, o.race_year;
