...
-- STEP #0a = CREATE UPDATED AT DATA TABLE
    -- CREATE INDEX idx_updated_at_members_desc ON all_membership_sales_data_2015_left (updated_at_members);
    -- CREATE INDEX idx_updated_at_profiles_desc ON all_membership_sales_data_2015_left (updated_at_profiles);

    -- SELECT * FROM all_membership_sales_data_2015_left ORDER BY id_membership_periods_sa DESC LIMIT 10;
    -- SELECT updated_at_mp, id_profiles FROM all_membership_sales_data_2015_left WHERE updated_at_mp IS NULL ORDER BY updated_at_mp DESC LIMIT 10;
    -- SELECT updated_at_members, id_profiles FROM all_membership_sales_data_2015_left WHERE updated_at_members IS NULL ORDER BY updated_at_members DESC LIMIT 10;
    -- SELECT updated_at_profiles, id_profiles FROM all_membership_sales_data_2015_left WHERE updated_at_profiles IS NULL ORDER BY updated_at_profiles DESC LIMIT 10;
