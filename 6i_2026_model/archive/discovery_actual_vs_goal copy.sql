...
-- CREATE SALES MODEL 2026
    ...
    sales_estimate_2026 AS (
        SELECT
            ...
            (p.units_nonbulk_2026 * p.price_2026_nonbulk)                      AS sales_rev_2026_goal_nonbulk,
            ((p.units_total_2026 - p.units_nonbulk_2026) * p.price_2026_bulk)  AS sales_rev_2026_goal_bulk,

            -- Units outputs (for parity with your original names)
            p.units_total_2026   AS sales_units_2026_goal,
            (p.units_total_2026 - p.units_nonbulk_2026) AS sales_units_2026_goal_bulk,
            p.units_nonbulk_2026 AS sales_units_2026_goal_nonbulk
