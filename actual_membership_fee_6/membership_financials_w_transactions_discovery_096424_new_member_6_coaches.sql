...
--  COACHES = actual_membership_fee_6 CALCULATION
    ...
    SELECT 
        ...
        MAX(
            CASE
                ...
                WHEN op.cart_label IS NOT NULL AND ((op.amount_per - op.discount - op.amount_refunded)  <= 0) THEN 0 -- todo: added
...
-- SELECT * FROM coaches_sales_actual_member_fee ORDER BY member_number_members
